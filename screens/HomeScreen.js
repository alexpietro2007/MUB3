...
export default function HomeScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <Pressable onPress={() => {
        navigation.navigate('SubMenu'); // troca para a tela "Details"
      }} style={({ pressed }) => [styles.button, pressed && styles.buttonPressed,]}><Text style={styles.menu}>Menu</Text></Pressable>
